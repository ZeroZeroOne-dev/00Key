...
const int KeyMap::_map[][ROW_COUNT][COL_COUNT] = {
    ...
    [1] = {  
        ...
        { KEY_NOKEY, KEY_NOKEY, KEY_NOKEY, KEY_NOKEY, KEY_NOKEY, KEY_NOKEY, KEY_NOKEY, KEY_NOKEY, KEY_NOKEY, KEY_NOKEY, KEY_NOKEY, KEY_NOKEY, KEY_NOKEY, KEY_NOKEY, KEY_NOKEY, KEY_NOKEY },
        { KEY_NOKEY, KEY_NOKEY, KEY_NOKEY, KEY_NOKEY, KEY_RED_DOWN, KEY_NOKEY, KEY_RED_UP, KEY_NOKEY, KEY_NOKEY, KEY_NOKEY, KEY_NOKEY, KEY_NOKEY, KEY_NOKEY, KEY_NOKEY, KEY_NOKEY, KEY_NOKEY },
        { KEY_NOKEY, KEY_NOKEY, KEY_NOKEY, KEY_NOKEY, KEY_NOKEY, KEY_GREEN_DOWN, KEY_NOKEY, KEY_GREEN_UP, KEY_NOKEY, KEY_NOKEY, KEY_NOKEY, KEY_NOKEY, KEY_NOKEY, KEY_NOKEY, KEY_NOKEY, KEY_NOKEY },
        { KEY_NOKEY, KEY_NOKEY, KEY_NOKEY, KEY_NOKEY, KEY_NOKEY, KEY_BLUE_DOWN, KEY_NOKEY, KEY_BLUE_UP, KEY_NOKEY, KEY_NOKEY, KEY_NOKEY, KEY_NOKEY, KEY_NOKEY, KEY_NOKEY, KEY_00KEY_BLUP, KEY_NOKEY },
