...
const int KeyMap::_map[][ROW_COUNT][COL_COUNT] = {
    [0] = {  
        ...
        { KEY_LEFT_CTRL, KEY_NOKEY, KEY_A, KEY_S, KEY_D, KEY_F, KEY_G, KEY_H, KEY_J, KEY_K, KEY_L, KEY_SEMICOLON, KEY_QUOTE, KEY_ENTER, KEY_NOKEY, KEY_PAGE_DOWN },
    ...
    [1] = {  
        ...
        { KEY_CAPS_LOCK, KEY_NOKEY, KEY_NOKEY, KEY_NOKEY, KEY_NOKEY, KEY_00KEY_GREEN_DOWN, KEY_NOKEY, KEY_00KEY_GREEN_UP, KEY_NOKEY, KEY_NOKEY, KEY_NOKEY, KEY_NOKEY, KEY_NOKEY, KEY_NOKEY, KEY_NOKEY, KEY_NOKEY },
